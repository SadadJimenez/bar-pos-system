...
import { type User, db } from '../db/database';
...
const LoginModule: React.FC<LoginModuleProps> = ({ onLogin }) => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        // Simulate a slight network delay for a more premium feel
                    ...
                    <div className="p-10 flex flex-col items-center">
                        ...
                        <form onSubmit={handleLogin} className="space-y-6 w-full">
                            <div className="space-y-2 group">
                                <label className="text-[10px] font-black uppercase tracking-widest text-text-muted ml-1 group-focus-within:text-primary transition-colors">Usuario</label>
                            ...
                            <div className="space-y-2 group">
                                <label className="text-[10px] font-black uppercase tracking-widest text-text-muted ml-1 group-focus-within:text-primary transition-colors">Contraseña</label>
                                <div className="relative">
